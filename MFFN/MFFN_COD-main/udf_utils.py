...
if __name__ == '__main__':
    ...
    mask_path = '/data1_ssd/gyy/CarDD/code/SOD/MFFN/output/MFFN_BS8_LR0.05_E50_H384_W384_OPMsgd_OPGMfinetune_SCf3_AMP_INFOdemo/pre/cardd_te'
    anno_path = '/data1_ssd/gyy/CarDD/data/CarDD_SOD/CarDD-TE/CarDD-TE-Mask'
    save_path = '/data1_hdd/gyy/CarDD/results/MFFN/test_overlap'
